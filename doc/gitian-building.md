...
git clone https://github.com/keymaker/keymaker
...
```bash
    ...
    From https://github.com/keymaker/keymaker
...
[keymaker/gitian.sigs](https://github.com/keymaker/gitian.sigs/) repository, or if that's not possible to create a pull
request.
