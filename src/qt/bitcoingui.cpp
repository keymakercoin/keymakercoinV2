...
void BitcoinGUI::createActions()
{
    ...
    coinJoinCoinsMenuAction->setStatusTip(tr("Send %1 funds to a Keymaker address").arg("CoinJoin"));
    ...
    aboutAction->setStatusTip(tr("Show information about Keymaker Core"));
...
void BitcoinGUI::updateWidth()
{
    ...
    // Use nButtonsVisible + 1 <- for the keymaker logo
...
{
    QString strTitle = tr("Keymaker Core"); // default title
