...
UniValue debug(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("debug", "keymaker")
            + HelpExampleRpc("debug", "keymaker+net")
        );
...
UniValue getaddressmempool(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "    \"satoshis\"  (number) The difference of bitting\n"
...
UniValue getaddressutxos(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "    \"satoshis\"  (number) The number of bitting of the output\n"
...
UniValue getaddressbalance(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"balance\": xxxxx,              (numeric) The current total balance in bitting\n"
            "  \"balance_immature\": xxxxx,     (numeric) The current immature balance in bitting\n"
            "  \"balance_spendable\": xxxxx,    (numeric) The current spendable balance in bitting\n"
            "  \"received\": xxxxx              (numeric) The total number of bitting received (including change)\n"
            "}\n"
            "\nExamples:\n"
